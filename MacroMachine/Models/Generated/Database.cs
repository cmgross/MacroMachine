...
//     Connection String:      `Data Source=(LocalDb)\MSSQLLocalDB;AttachDbFilename=C:\VS\Visual Studio 2015\Projects\MacroMachine\MacroMachine\App_Data\\aspnet-MacroMachine-20160516104229.mdf;Initial Catalog=aspnet-MacroMachine-20160516104229;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace db
{
	...
	public partial class dbDB : Database
	{
		public dbDB() 
			: base("db")
		{
		...
		public dbDB(string connectionStringName) 
        ...
        public static dbDB GetInstance()
        {
			if (_instance!=null)
				return _instance;
		...
		[ThreadStatic] static dbDB _instance;
		...
		{
			public static dbDB repo { get { return dbDB.GetInstance(); } }
	...
	[ExplicitColumns]
    public partial class __MigrationHistory : dbDB.Record<__MigrationHistory>  
    {
	...
	[ExplicitColumns]
    public partial class AspNetRole : dbDB.Record<AspNetRole>  
    {
	...
	[ExplicitColumns]
    public partial class AspNetUserClaim : dbDB.Record<AspNetUserClaim>  
    {
	...
	[ExplicitColumns]
    public partial class AspNetUserLogin : dbDB.Record<AspNetUserLogin>  
    {
	...
	[ExplicitColumns]
    public partial class AspNetUserRole : dbDB.Record<AspNetUserRole>  
    {
	...
	[ExplicitColumns]
    public partial class AspNetUser : dbDB.Record<AspNetUser>  
    {
